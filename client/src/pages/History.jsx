...
import emojiPattern from '../assets/emoji-pattern.png'; // ✅ Using same image as other pages
...
export default function HistoryPage() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-3xl font-bold mb-6 text-center">📊 Quiz History</h1>
        ...
        {filteredHistory.length ? (
          ...
          <p className="text-sm text-gray-500 text-center">No matching history found.</p>
        )}

        <div className="h-64 mt-8 bg-white/80 dark:bg-gray-900/80 rounded p-4 shadow">
